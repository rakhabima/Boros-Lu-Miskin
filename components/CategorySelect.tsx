...
export function CategorySelect({
  ...
  useEffect(() => {
    ...
    // eslint-disable-next-line react-hooks/set-state-in-effect -- syncs highlight/focus with the external DOM focus target when the listbox opens; ported verbatim from frontend/src/components/CategorySelect.tsx
